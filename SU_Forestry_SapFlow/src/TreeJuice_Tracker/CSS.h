...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>TJT Server</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("ul{list-style-type:none;padding:0;border-radius:0em;overflow:hidden;background-color:#D4AC0D;font-size:1em;}");
  webpage += F("li{float:left;border-radius:0em;border-right:0em solid #bbb;}");
  webpage += F("li a{color:#F7F9F9; display: block;border-radius:0.375em;padding:0.44em 0.44em;text-decoration:none;font-size:100%}");
  webpage += F("li a:hover{background-color:#F7DC6F;border-radius:0em;font-size:100%}");
  webpage += F("h1{color:#F7F9F9;border-radius:0em;font-size:1.5em;padding:0.2em 0.2em;background:#D4AC0D;}");
  ...
  webpage += F("</style></head><body><h1>Tree Juice Tracker Sensors</h1>");
  webpage += F("<ul>");
